...
<head>
    ...
    <title>Reset Password | EZ-Seed</title>
        ...
        <aside class="relative lg:w-[42%] h-screen overflow-hidden bg-da-green-900">
            ...
            <div class="max-w-md mx-auto lg:mx-0 w-full">
                ...
                <p class="text-base sm:text-lg text-da-green-900/70 leading-relaxed mb-6">
                    Choose a new password to regain access to the DA Analytics Dashboard for
            ...
            <div class="max-w-xl mx-auto w-full bg-white rounded-3xl ring-1 ring-da-green-900/10 shadow-[0_10px_40px_-15px_rgba(15,74,15,0.15)] p-6 sm:p-8">
                ...
                <form method="POST" action="{{ route('password.store') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="field-input block mt-1 w-full" type="email" name="email" :value="old('email', $request->email)" required autofocus autocomplete="username" />
                    ...
                    <div class="mt-4">
                        ...
                        <div class="relative mt-1">
                            <x-text-input id="password" class="field-input block w-full pr-12" type="password" name="password" required autocomplete="new-password" />
                    ...
                    <!-- Confirm Password -->
                    <div class="mt-4">
                        <x-input-label for="password_confirmation" :value="__('Confirm Password')" class="field-label" />

                        <div class="relative mt-1">
                            <x-text-input id="password_confirmation" class="field-input block w-full pr-12"
                                                type="password"
