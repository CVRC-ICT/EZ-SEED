...
<head>
    ...
    <style>
        ...
        /* Lighter, outlined inputs with larger type */
        .field-input {
...
<body class="bg-da-cream antialiased h-screen overflow-hidden">
    ...
    <div class="h-screen lg:flex">
        ...
        <aside class="relative lg:w-[42%] h-screen overflow-hidden bg-da-green-900">
            ...
            <div class="max-w-md mx-auto lg:mx-0 w-full">
                ...
                <p class="text-base sm:text-lg text-da-green-900/70 leading-relaxed mb-6">
                    Sign in to the DA Analytics Dashboard to monitor survey responses, analyze seed variety
                    trends, and generate province-level reports for
        ...
        <main class="lg:w-[58%] h-screen bg-white lg:rounded-l-[2.5rem] lg:shadow-[0_0_60px_-15px_rgba(15,74,15,0.15)] px-6 sm:px-10 lg:px-16 py-8 lg:py-10 flex flex-col justify-center overflow-y-auto">
            ...
            <a href="{{ route('landing') }}" class="max-w-xl mx-auto w-full inline-flex items-center gap-2 text-sm font-semibold text-da-green-900/50 hover:text-da-green-700 mb-4">
            ...
            <div class="max-w-xl mx-auto w-full bg-white rounded-3xl ring-1 ring-da-green-900/10 shadow-[0_10px_40px_-15px_rgba(15,74,15,0.15)] p-6 sm:p-8">
                ...
                <div class="flex items-center gap-2 mb-2">
                    <span class="text-xs font-bold uppercase tracking-[0.14em] text-da-green-700">Welcome back</span>
                ...
                <p class="text-base text-da-green-900/60 mb-5">
                    Sign in with your DA personnel account to continue.
                </p>
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div>
                        ...
                        <x-text-input id="email" class="field-input block mt-1 w-full" type="email" name="email" :value="old('email')" required autofocus autocomplete="username" />
                    ...
                    <div class="mt-4">
                        ...
                        <div class="relative mt-1">
                            <x-text-input id="password" class="field-input block w-full pr-12"
                                            type="password"
                                            name="password"
                            ...
                            <button type="button"
                                    ...
                                    class="password-toggle-btn absolute inset-y-0 right-0 flex items-center pr-3.5 text-da-green-900/40 hover:text-da-green-700">
                                <svg class="eye-icon" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                <svg class="eye-off-icon hidden" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
